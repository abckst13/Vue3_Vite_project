                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        ...
                                        <div class="text-inverse text-opacity-50 d-flex align-items-center">Friends only</div>
                                    </div>
                                    <div>
                                        <a href="#modalEdit" data-bs-toggle="modal" class="btn btn-outline-default w-100px">Edit</a>
                                    </div>
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        ...
                                        <div class="text-inverse text-opacity-50 d-block d-xl-flex align-items-center">
                                            ...
                                            <span
                                                class="bg-warning-transparent-1 text-warning ms-xl-3 mt-1 d-inline-block mt-xl-0 px-1 rounded-sm"
                                            >
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        ...
                                        <div class="text-inverse text-opacity-50">Local, Domestic</div>
                                    </div>
                                    <div>
                                        <a href="#modalEdit" data-bs-toggle="modal" class="btn btn-outline-default w-100px">Edit</a>
                                    </div>
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        ...
                                        <div class="text-inverse text-opacity-50">.png, .jpg, .gif, .mp4</div>
                                    </div>
                                    <div>
                                        <a href="#modalEdit" data-bs-toggle="modal" class="btn btn-outline-default w-100px">Edit</a>
                                    </div>
                        ...
                        <card>
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        <div>Web storage</div>
                                        <div class="text-inverse text-opacity-50">40.8gb / 100gb</div>
                                    </div>
                                    <div>
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        ...
                                        <div class="text-inverse text-opacity-50">Unlimited</div>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        <div>Database</div>
                                        <div class="text-inverse text-opacity-50">MySQL version 8.0.19</div>
                                    </div>
                                    <div>
                                        <a href="#modalEdit" data-bs-toggle="modal" class="btn btn-outline-default w-100px disabled"
                                            >Update</a
                                        >
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                    <div class="flex-1 text-break">
                                        <div>Platform</div>
                                        <div class="text-inverse text-opacity-50">PHP 7.4.4, NGINX 1.17.0</div>
                                    </div>
                                    <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert bg-inverse bg-opacity-10 border-0">
                        <b>Please note:</b>
                        If you change your name, you can't change it again for 60 days. Don't add any unusual capitalization, punctuation,
