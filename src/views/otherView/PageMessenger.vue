                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu fs-12px fw-bold">
                                <a href="#" class="dropdown-item d-flex align-items-center"
                                    ><i class="bi bi-pencil-square fs-14px my-n1 me-2"></i> EDIT</a
                                >
                                <a href="#" class="dropdown-item d-flex align-items-center"
                                    ><i class="bi bi-info-circle fs-14px my-n1 me-2"></i> INFO</a
                                >
                                <a href="#" class="dropdown-item d-flex align-items-center"
                                    ><i class="bi bi-bell-slash fs-14px my-n1 me-2"></i> MUTE</a
                                >
                                <a href="#" class="dropdown-item d-flex align-items-center"
                                    ><i class="bi bi-x-circle fs-14px my-n1 me-2"></i> CLEAR CHAT HISTORY</a
                                >
                                <div class="dropdown-divider"></div>
                                <a href="#" class="dropdown-item d-flex align-items-center text-danger"
                                    ><i class="bi bi-trash fs-14px my-n1 me-2"></i> DELETE AND LEAVE</a
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="widget-chat">
                            ...
                            <div class="widget-chat-item">
                                ...
                                <div class="widget-chat-content">
                                    ...
                                    <div class="widget-chat-message">Hey folks, please check your emails. I have shared you the slide.</div>
                            ...
                            <div class="widget-chat-item">
                                ...
                                <div class="widget-chat-content">
                                    ...
                                    <div class="widget-chat-message">Hi, will be a little late to the production meeting.</div>
                                    <div class="widget-chat-status">2:21PM</div>
                                </div>
                            </div>
                            <div class="widget-chat-item reply">
                                <div class="widget-chat-content">
                                    <div class="widget-chat-message last">No problem. I will be sure to take notes.</div>
                            ...
                            <div class="widget-chat-item">
                                ...
                                <div class="widget-chat-content">
                                    <div class="widget-chat-name">Roberto Lambert</div>
                                    <div class="widget-chat-message">Thank you! I should be there by 9:10.</div>
                                    <div class="widget-chat-status">2:25PM</div>
                                </div>
                            </div>
                            <div class="widget-chat-item reply">
                                <div class="widget-chat-content">
                                    <div class="widget-chat-message last">Don't rush. I've got it covered.</div>
                            ...
                            <div class="widget-chat-item">
                                ...
                                <div class="widget-chat-content">
                                    <div class="widget-chat-name">Roberto Lambert</div>
                                    <div class="widget-chat-message">Hey Gabe, can you forward me the meeting notes?</div>
