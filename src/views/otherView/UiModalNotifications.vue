            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <h1 class="page-header">Modal & Notification <small>page header description goes here...</small></h1>
                        ...
                        <div id="modal" class="mb-5">
                            ...
                            <p>
                                ...
                                completely custom content. Please read the
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline-default" data-bs-dismiss="modal">
                                                        Close
                                                    </button>
                        ...
                        <div id="modalCover" class="mb-5">
                            <h4>Modal Cover</h4>
                            <p>
                                Modal cover is an extended feature from Bootstrap modal. It provide the same background color as the modal
                                content. Place a <code>.modal-cover</code> css class on <code>.modal</code> for full cover modal.
                            </p>
                            <card>
                                <card-body>
                                    <!-- modal-cover -->
                        ...
                        <div id="toastsContainer" class="mb-5">
                            ...
                            <p>
                                Toasts container is an extended ui from Bootstrap toasts. Wrap the toasts with
                                <code>.toasts-container</code> will allow toast to float within the right top position.
                            </p>
                            <card>
                                <card-body>
                                    <a href="#" class="btn btn-outline-theme me-2" @click="event => showToast(event, 'toast-1')"
                                        >Show toast 1</a
                                    >
                                    <a href="#" class="btn btn-outline-theme" @click="event => showToast(event, 'toast-2')">Show toast 2</a>
                                </card-body>
