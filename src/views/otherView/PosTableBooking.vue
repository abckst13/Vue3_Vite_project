    ...
    methods: {
        ...
        getAvailableTable() {
            ...
            for (let i = 0; i < this.tables.length; i++) {
                for (let x = 0; x < this.tables[i].reservation.length; x++) {
        ...
        checkSameHour(time) {
            ...
            const currentTime = currentHour + ':00' + currentAmPm;
            ...
            <div class="pos-content">
                <div class="pos-content-container h-100 p-4" data-scrollbar="true" data-height="100%">
                    ...
                    <div class="row gx-4">
                                ...
                                <card-body class="p-1">
                                    <div class="pos-table-booking-container">
                                        ...
                                        <div class="pos-table-booking-body">
                                            <div
                                                class="booking"
                                                v-for="reservation in table.reservation"
                                            ...
                                            >
                                                ...
                                                <div class="status" v-bind:class="getStatus(reservation.time, reservation.text)">
                                                    <i class="fa fa-circle" v-if="reservation.text"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" v-else>No records found</div>
                    </div>
                </div>
            </div>
            <!-- END pos-content -->
