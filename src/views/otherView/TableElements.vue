            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <h1 class="page-header">Table Elements <small>page header description goes here...</small></h1>
                        ...
                        <div id="basicTable" class="mb-5">
                            <h4>Basic Table</h4>
                            <p>
                                Using the most basic table markup, here’s how .table-based tables look in Bootstrap. You can also invert the
                                colors—with light text on dark backgrounds—with <code>.table-dark</code>.
                            </p>
                            <card>
                                <card-body>
                                    <div class="row mb-n3">
                                        <div class="col-xl-6">
                                            <div class="small text-inverse text-opacity-50 mb-3"><b>DEFAULT TABLE</b></div>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">#</th>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="small text-inverse text-opacity-50 mb-3"><b>DARK TABLE</b></div>
                        ...
                        <div id="tableHeadOptions" class="mb-5">
                            ...
                            <card>
                                <card-body>
                                    <div class="row mb-n3">
                                        <div class="col-xl-6">
                                            <div class="small text-inverse text-opacity-50 mb-3"><b>DARK HEADER</b></div>
                                            <table class="table">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="small text-inverse text-opacity-50 mb-3"><b>LIGHT HEADER</b></div>
                                            <table class="table">
                        ...
                        <div id="responsiveTables" class="mb-5">
                            ...
                            <p>
                                ...
                                viewports by wrapping a <code>.table</code> with <code>.table-responsive</code>. Or, pick a maximum
                    ...
                    <div class="col-xl-3">
                        ...
                        <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                            <nav class="nav">
                                ...
                                <nav-scroll-to class="nav-link" target="#tableHeadOptions" data-toggle="scroll-to"
                                    >Table head options</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#stripedRows" data-toggle="scroll-to">Striped rows</nav-scroll-to>
                                <nav-scroll-to class="nav-link" target="#borderedTable" data-toggle="scroll-to"
                                    >Bordered table</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#borderlessTable" data-toggle="scroll-to"
                                    >Borderless table</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#hoverableRows" data-toggle="scroll-to"
                                    >Hoverable rows</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#smallTable" data-toggle="scroll-to">Small table</nav-scroll-to>
                                <nav-scroll-to class="nav-link" target="#contextualClasses" data-toggle="scroll-to"
                                    >Contextual classes</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#captions" data-toggle="scroll-to">Captions</nav-scroll-to>
                                <nav-scroll-to class="nav-link" target="#responsiveTables" data-toggle="scroll-to"
                                    >Responsive tables</nav-scroll-to
                                >
                            </nav>
                        </nav>
