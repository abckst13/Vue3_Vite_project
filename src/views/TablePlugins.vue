                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div id="vue3TableLite" class="mb-5">
                            ...
                            <p>
                                Vue3 Table Lite is a simple and lightweight data table component for Vue.js 3. Features sorting, paging, row
                                check, dynamic data rendering, supported TypeScript, and more. Please read the
                                <a href="https://github.com/linmasahiro/vue3-table-lite" target="_blank">official documentation</a> for the
                    ...
                    <div class="col-xl-3">
                        ...
                        <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                            <nav class="nav">
                                <nav-scroll-to class="nav-link" target="#vue3TableLite" data-toggle="scroll-to"
                                    >Vue3 Table Lite</nav-scroll-to
                                >
                            </nav>
                        </nav>
