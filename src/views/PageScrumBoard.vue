...
<template>
    ...
    <div class="mb-md-4 mb-3 d-md-flex">
        <div class="dropdown-toggle">
            <a href="#" data-bs-toggle="dropdown" class="text-inverse text-opacity-75 text-decoration-none"
                ><i class="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/hud</a
            >
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <div class="fw-400 me-2">Task (2/3)</div>
                                <div>
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="mb-1 d-flex align-items-center">
                                ...
                                <div class="widget-user-list">
                                    <div class="widget-user-list-item w-30px h-30px">
                                        <div class="widget-user-list-link w-30px h-30px">
                                            <img src="/assets/img/user/user-1.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div class="widget-user-list-item w-30px h-30px ms-n2">
                                        <div class="widget-user-list-link w-30px h-30px">
                                    ...
                                    <div class="widget-user-list-item w-30px h-30px ms-n2">
                                        <div class="widget-user-list-link w-30px h-30px bg-gray-200 text-gray-500 fs-12px fw-400">+2</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <div class="fw-400 me-2">Task (1/2)</div>
                                <div>
                                    <a
                                        href="#"
                            ...
                            <div class="form-group mb-1">
                                <div class="collapse show" id="inProgressBoard">
                                    <div class="form-check mb-2px">
                                        ...
                                        <label class="form-check-label small" for="customCheck4"
                                            >check all browser compatibility for HTML5 flexbox</label
                                        >
                                    </div>
                                    <div class="form-check mb-2px">
                                        <input type="checkbox" class="form-check-input" id="customCheck5" />
                                        <label class="form-check-label small" for="customCheck5"
                                            >fallback integration by using other display property</label
                                        >
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <hr class="mt-15px mb-15px" />
                            <div class="d-flex align-items-center mb-2">
                                <div class="fw-400 me-2">Task (0/1)</div>
                                <div>
                                    <a
                                        href="#"
                                        class="text-inverse text-opacity-50"
                            ...
                            <div class="form-group mb-1">
                                <div class="collapse show" id="inProgress2Board">
                                    <div class="form-check mb-2px">
                                        ...
                                        <label class="form-check-label small" for="customCheck6"
                                            >debug and fix mobile auto close while using GPS issue</label
                                        >
                                    </div>
                                </div>
                            </div>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <hr class="my-3" />
                            <div class="d-flex align-items-center mb-2">
                                <div class="fw-400 me-2">Task (3/3)</div>
                                <div>
                                    <a
                                        href="#"
                                        class="text-inverse text-opacity-50"
                            ...
                            <div class="form-group mb-1">
                                <div class="collapse show" id="completedBoard">
                                    ...
                                    <div class="form-check mb-2px">
                                        ...
                                        <label class="form-check-label small" for="customCheck9"
                                            >backend integration for data filter with daterange input</label
                                        >
                                    </div>
                                </div>
                            </div>
