                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        <div class="desktop-sticky-top">
                            ...
                            <p>
                                Principal UXUI Design & Brand Architecture for HUD. Creator of SeanTheme. Bringing the world closer
                                together. Studied Computer Science and Psychology at Harvard University.
                            </p>
                            <div class="mb-1"><i class="fa fa-map-marker-alt fa-fw text-inverse text-opacity-50"></i> New York, NY</div>
                            <div class="mb-3"><i class="fa fa-link fa-fw text-inverse text-opacity-50"></i> seantheme.com/hud</div>
                                                ...
                                                <card-body>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold">
                                                                <a href="#" class="text-decoration-none">Clyde Stanley</a> at
                                                                <a href="#" class="text-decoration-none">South Lake Tahoe, California</a>
                                                            </div>
                                                        ...
                                                        <div class="flex-fill ps-2">
                                                            <div class="position-relative d-flex align-items-center">
                                                                ...
                                                                <div class="position-absolute end-0 text-center">
                                                                    <a href="#" class="text-inverse text-opacity-50 me-2"
                                                                    ...
                                                                    ></a>
                                                                    <a href="#" class="text-inverse text-opacity-50 me-3"
                                                                        ><i class="fa fa-paw"></i
                                                                    ></a>
                                                                </div>
                                                            </div>
                                            ...
                                            <card class="mb-3">
                                                <card-body>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold">
                                                                <a href="#" class="text-decoration-none">Clyde Stanley</a> is watching
                                                                <a href="#" class="text-decoration-none">PATAGONIA 8k</a>
                                                            </div>
                                            ...
                                            <card class="mb-3">
                                                <card-body>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold">
                                                                <a href="#" class="text-decoration-none">Clyde Stanley</a>
                                                            </div>
                                                    ...
                                                    <p>
                                                        ...
                                                        Ut auctor congue efficitur. Praesent aliquam pulvinar neque, placerat semper massa
                                                        elementum et.
                                                    </p>
                                                    <hr class="mb-1" />
                                                ...
                                                <card-body>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold">
                                                                <a href="#" class="text-decoration-none">Clyde Stanley</a> at
                                                                <a href="#" class="text-decoration-none">United States</a>
                                                            </div>
                                                    ...
                                                    <div class="profile-img-list">
                                                        ...
                                                        <div class="profile-img-list-item">
                                                            <a
                                                                ...
                                                                ><span
                                                                    class="profile-img-content"
                                                                    style="background-image: url(/assets/img/gallery/gallery-7.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="profile-img-list-item">
                                                        ...
                                                        <div class="profile-img-list-item">
                                                            <a
                                                                ...
                                                                ><span
                                                                    class="profile-img-content"
                                                                    style="background-image: url(/assets/img/gallery/gallery-9.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="profile-img-list-item">
                                                            <a
                                                                ...
                                                                ><span
                                                                    class="profile-img-content"
                                                                    style="background-image: url(/assets/img/gallery/gallery-10.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="profile-followers">
                                            <div class="list-group">
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Ethel Wilkes</a>
                                                        </div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Shanaya Hansen</a>
                                                        </div>
                                                        <div class="text-inverse text-opacity-50 fs-13px">North Raundspic</div>
                                                    </div>
                                                    <a href="#" class="btn btn-outline-theme">Follow</a>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">James Allman</a>
                                                        </div>
                                                        <div class="text-inverse text-opacity-50 fs-13px">North Raundspic</div>
                                                    </div>
                                                    <a href="#" class="btn btn-outline-theme">Follow</a>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Marie Welsh</a>
                                                        </div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Lamar Kirkland</a>
                                                        </div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none"
                                                                >Bentley Osborne</a
                                                            >
                                                        </div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Ollie Goulding</a>
                                                        </div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Hiba Calvert</a>
                                                        </div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div>
                                                            <a href="#" class="text-inverse fw-bold text-decoration-none">Rivka Redfern</a>
                                                        </div>
                                            ...
                                            <div class="text-center p-3">
                                                <a href="#" class="text-inverse text-decoration-none">Show more <b class="caret"></b></a>
                                            </div>
                                        </div>
                                        <!-- END tab-pane -->
                                        ...
                                        <div class="tab-pane fade" id="profile-media">
                                            <card class="mb-3">
                                                ...
                                                <card-body>
                                                    <div class="widget-img-list">
                                                        ...
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-6.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-6.jpg)"
                                                                ></span
                                                        ...
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-7.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-7.jpg)"
                                                                ></span
                                                        ...
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-8.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-8.jpg)"
                                                                ></span
                                                        ...
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-9.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-9.jpg)"
                                                                ></span
                                                        ...
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-10.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-10.jpg)"
                                                                ></span
                                                        ...
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-11.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-11.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-12.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-12.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                    </div>
                                            ...
                                            <card>
                                                ...
                                                <card-body>
                                                    <div class="widget-img-list">
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-13.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-13.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-14.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-14.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-15.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-15.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-16.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-16.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-17.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-17.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-18.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-18.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-19.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-19.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                                            <a href="/assets/img/gallery/gallery-20.jpg" data-lity
                                                                ><span
                                                                    class="img"
                                                                    style="background-image: url(/assets/img/gallery/gallery-20.jpg)"
                                                                ></span
                                                            ></a>
                                                        </div>
                                                        <div class="widget-img-list-item">
                                            ...
                                            <div class="list-group list-group-flush">
                                                ...
                                                <div class="list-group-item px-3">
                                                    <div class="text-inverse text-opacity-50">
                                                        <small><strong>Trending Worldwide</strong></small>
                                                    </div>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                <div class="col-md-4 d-flex">
                                                                    <div
                                                                        class="h-100 w-100"
                                                                        style="
                                                                            background: url(/assets/img/gallery/news-1.jpg) center;
                                                ...
                                                <div class="list-group-item px-3">
                                                    ...
                                                    <div>
                                                        <small class="text-inverse text-opacity-50"
                                                            ><i class="fa fa-external-link-square-alt"></i> Promoted by HUD Trolls</small
                                                        >
                                                    </div>
                                                </div>
                                                <div class="list-group-item px-3">
                                                    ...
                                                    <div class="fs-13px mb-1">
                                                        The coronavirus is affecting 210 countries around the world and 2 ...
                                                    </div>
                                                    <div><small class="text-inverse text-opacity-50">49.3m share</small></div>
                                                </div>
                                                <div class="list-group-item px-3">
                                                    <div class="text-inverse text-opacity-50">
                                                        <small><strong>Trending in New York</strong></small>
                                                    </div>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                <div class="col-md-4 d-flex">
                                                                    <div
                                                                        class="h-100 w-100"
                                                                        style="
                                                                            background: url(/assets/img/gallery/news-2.jpg) center;
                                                                            background-size: cover;
                                                                        "
                                                                    ></div>
                                                                </div>
                                                ...
                                                <a href="#" class="list-group-item list-group-action text-center"> Show more </a>
                                            </div>
                                        </card>
                                    </div>
                                </div>
