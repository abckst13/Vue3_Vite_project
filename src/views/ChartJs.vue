                ...
                datasets: [
                    {
                        ...
                        backgroundColor: [
                            ...
                            'rgba(' + appVariable.color.inverseRgb + ', .2)' + ', .5)',
                ...
                datasets: [
                    {
                        ...
                        hoverBackgroundColor: [
                            ...
                            'rgba(' + appVariable.color.inverseRgb + ', 1)',
                            'rgba(' + appVariable.color.gray900Rgb + ', 1)'
                        ],
                        borderWidth: 0
                    }
                ]
            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <h1 class="page-header">Chart.js <small>page header description goes here...</small></h1>
                        ...
                        <div id="chartJs">
                            <h4>Basic Example</h4>
                            <p>
                                Chart.js is a simple yet flexible JavaScript charting for designers & developers. Please read the
                                <a href="https://www.chartjs.org/" target="_blank">official documentation</a> for the full list of options.
                            </p>
                        </div>
                        <!-- END #chartJs -->
                    ...
                    <div class="col-xl-3">
                        ...
                        <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                            <nav class="nav">
                                ...
                                <nav-scroll-to class="nav-link" target="#chartJsLineChart" data-toggle="scroll-to">
                                    - line chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#chartJsBarChart" data-toggle="scroll-to">
                                    - bar chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#chartJsRadarChart" data-toggle="scroll-to">
                                    - radar chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#chartJsPolarAreaChart" data-toggle="scroll-to">
                                    - polar area chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#chartJsPieChart" data-toggle="scroll-to">
                                    - pie chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#chartJsDoughnutChart" data-toggle="scroll-to">
                                    - doughnut chart</nav-scroll-to
                                >
                            </nav>
                        </nav>
