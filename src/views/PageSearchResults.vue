<template>
    ...
    <h1 class="page-header">Search Results <small>page header description goes here...</small></h1>
            ...
            <div class="search-result-list">
                <div class="search-result-item">
                    ...
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook features sixth-generation Intel Core processors, improved graphics performance, and up to 10 hours of
                            battery life.
                        </p>
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            The incredibly thin and light MacBook features sixth-generation processors, improved graphics performance, and
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook Pro - macOS - Apple macOS. It’s why there’s nothing else like a Mac. macOS is the operating system that
                            powers every Mac. It lets you do things you simply can’t with other computers. That’s...
                        </p>
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook Air is incredibly thin and light. But it’s also powerful, durable, and enjoyable to use. With enough
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook Air is packed with powerful components that give you smoother graphics, faster storage, and all-around
                            serious performance....
                        </p>
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            View the technical specifications for MacBook Air, see what comes in the box, explore configuration options, and
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook is the thinnest and lightest Mac notebook ever — each detail refined for maximum efficiency and
                            portability.
                        </p>
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>View the technical specifications for MacBook. See what comes in the box and get a list of accessories.</p>
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook is designed to make the most of the wireless world. Share files, browse the web, print, and more —
                ...
                <div class="search-result-item">
                    <div class="search-result-content">
                        ...
                        <p>
                            MacBook - macOS - Apple macOS. It’s why there’s nothing else like a Mac. macOS is the operating system that
                            powers every Mac. It lets you do things you simply can’t with other computers. That’s...
                        </p>
