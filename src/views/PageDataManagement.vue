        ...
        <DataTable class="table table-bordered table-xs w-100 fw-bold text-nowrap mb-3" :options="tableOption">
            ...
            <tbody class="text-body">
                ...
                <tr>
                    ...
                    <td>
                        0
                        <a href="#" class="text-warning" data-bs-toggle="tooltip" data-bs-title="Out of Stock"
                        ...
                        <div class="col-sm-7 py-1 fs-13px">
                            ...
                            <div class="row mb-10px">
                                ...
                                <div class="col-8 text-white">
                                    <span class="badge bg-theme text-black text-opacity-75 py-1 fs-10px my-n1 fw-bold">PHONE</span>
                                </div>
                            </div>
                            <div class="row mb-10px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 text-white">
                                    <input type="text" class="form-control form-control-sm w-100px" value="20" />
                                </div>
                            </div>
                        </div>
                    </div>
