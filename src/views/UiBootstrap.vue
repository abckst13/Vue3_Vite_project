                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div id="alert" class="mb-5">
                            <h4>Alerts</h4>
                            <p>
                                Wrap any text and an optional dismiss button in <code>.alert</code> and one of the four contextual classes
                                for basic alert messages. Please read the
                            ...
                            <card>
                                <card-body>
                                    <div class="alert alert-primary"><strong>Primary!</strong> A simple primary alert check it out!</div>
                                    ...
                                    <div class="alert alert-dark"><strong>Dark!</strong> A simple dark alert—check it out!</div>
                                    <div class="alert alert-light mb-0"><strong>Light!</strong> A simple light alert—check it out!</div>
                                </card-body>
                        ...
                        <div id="badge" class="mb-5">
                            <h4>Badges</h4>
                            <p>
                                Documentation and examples for badges, our small count and labeling component. Please read the
                        ...
                        <div id="breadcrumb" class="mb-5">
                            ...
                            <p>
                                ...
                                CSS. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/breadcrumb/" target="_blank"
                                    >official Bootstrap documentation</a
                                >
                                for the full list of options.
                            </p>
                        ...
                        <div id="carousel" class="mb-5">
                            <h4>Carousel</h4>
                            <p>
                                A slideshow component for cycling through elements—images or slides of text—like a carousel. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/carousel/" target="_blank"
                                    >official Bootstrap documentation</a
                                >
                                for the full list of options.
                            </p>
                        ...
                        <div id="listGroup" class="mb-5">
                            <h4>List Group</h4>
                            <p>
                                List groups are a flexible and powerful component for displaying a series of content. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/list-group/" target="_blank"
                                    >official Bootstrap documentation</a
                                >
                                for the full list of options.
                            </p>
                        ...
                        <div id="mediaObject" class="mb-5">
                            <h4>Media Object</h4>
                            <p>
                                Media object is created by using Bootstrap utilities class and it is construct highly repetitive components
                                like blog comments, tweets, and the like.
                            </p>
                            <card>
                                <card-body>
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="d-flex align-items-start mt-3">
                                                <a href="#">
                                                    <img
                                                        src="https://via.placeholder.com/128x128/c9d2e3/212837"
                                                        alt=""
                                                        width="64"
                                                        class="rounded"
                                                    />
                        ...
                        <div id="navs" class="mb-5">
                            ...
                            <p>
                                ...
                                and disabled states. Swap modifier classes to switch between each style. Please read the
                        ...
                        <div id="navbar" class="mb-5">
                            <h4>Narbar</h4>
                            <p>
                                Includes support for branding, navigation, and more, including support for collapse plugin. Please read the
                        ...
                        <div id="pagination" class="mb-5">
                            ...
                            <p>
                                ...
                                multiple pages. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/pagination/" target="_blank"
                                    >official Bootstrap documentation</a
                                >
                                for the full list of options.
                            </p>
                        ...
                        <div id="progress" class="mb-5">
                            ...
                            <p>
                                ...
                                animated backgrounds, and text labels. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/progress/" target="_blank"
                                    >official Bootstrap documentation</a
                                >
                                for the full list of options.
                            </p>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3">
                                                <div class="mb-2 small text-inverse text-opacity-50">
                                                    <b class="fw-bold">MULTIPLE BARS</b>
                                                </div>
                                                <div class="progress">
                        ...
                        <div id="spinners" class="mb-5">
                            ...
                            <p>
                                ...
                                and no JavaScript. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/spinners/" target="_blank"
                                    >official Bootstrap documentation</a
                                >
                                for the full list of options.
                            </p>
                                ...
                                <card-body class="pb-0">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-4">
                                                <div class="mb-2 small text-inverse text-opacity-50">
                                                    <b class="fw-bold">BORDER SPINNER</b>
                                                </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-4">
                                                <div class="mb-2 small text-inverse text-opacity-50">
                                                    <b class="fw-bold">GROWING SPINNER</b>
                                                </div>
