        ...
        <div class="flex-1">
            ...
            <div class="coming-soon-content d-flex flex-column">
                <div class="flex-1 mb-3">
                    ...
                    <p class="mb-4">
                        We are working very hard on the new version of our site.<br />
                ...
                <div class="text-center small text-inverse text-opacity-50">&copy; {{ year }} SeanTheme Right Reserved</div>
            </div>
