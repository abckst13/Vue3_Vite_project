...
<template>
    <perfect-scrollbar class="app-content-inner-padding h-100">
        ...
        <h1 class="page-header">Full Height <small>page header description goes here...</small></h1>

        <hr class="mb-4" />

        <p>Add the following code within the <code>&lt;script&gt;</code> tag for full height page setting.</p>
