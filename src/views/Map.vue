        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    <!-- BEGIN col-9 -->
                    <div class="col-xl-9">
                        <h1 class="page-header">Map <small>page header description goes here...</small></h1>
                        ...
                        <div id="jsvectormap" class="mb-5">
                            ...
                            <p>
                                ...
                                Please read the
                                <a href="https://github.com/themustafaomar/jsvectormap" target="_blank">official documentation</a> for the
                        ...
                        <div id="vue3GoogleMap" class="mb-5">
                            ...
                            <p>
                                ...
                                Please read the
                                <a href="https://vue3-google-map.netlify.app/" target="_blank">official documentation</a> for the full list
                                of options.
                            </p>
                            <card>
                                <card-body>
                    ...
                    <div class="col-xl-3">
                        ...
                        <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                            <nav class="nav">
                                ...
                                <nav-scroll-to class="nav-link" target="#vue3GoogleMap" data-toggle="scroll-to"
                                    >Vue3 Google Map</nav-scroll-to
                                >
                            </nav>
                        </nav>
