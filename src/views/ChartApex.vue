    ...
    methods: {
        ...
        getChart7Options() {
            return {
                ...
                colors: [
                    ...
                    'rgba(' + appVariable.color.inverseRgb + ', .5)',
        ...
        getChart10Options() {
            return {
                ...
                stroke: { show: false },
                colors: [
                    'rgba(' + appVariable.color.pinkRgb + ', .75)',
                    'rgba(' + appVariable.color.warningRgb + ', .75)',
                    'rgba(' + appVariable.color.themeRgb + ', .75)',
                    'rgba(' + appVariable.color.inverseRgb + ', .5)',
                    'rgba(' + appVariable.color.indigoRgb + ', .75)'
                ],
                ...
                plotOptions: {
                    radar: {
                        ...
                        polygons: {
                            ...
                            fill: {
                                colors: [
                                    'rgba(' + appVariable.color.gray300Rgb + ', .25)',
        ...
        return {
            ...
            chart7: {
                ...
                series: [
                    {
                        name: 'Bubble1',
                        data: this.generateBubbleChartData(new Date('11 Feb 2022 GMT').getTime(), 20, { min: 10, max: 60 })
                    },
                    {
                        name: 'Bubble2',
                        data: this.generateBubbleChartData(new Date('11 Feb 2022 GMT').getTime(), 20, { min: 10, max: 60 })
            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <h1 class="page-header">Apexcharts.js <small>page header description goes here...</small></h1>
                        ...
                        <div id="apexChart">
                            <h4>Basic Example</h4>
                            <p>
                                Apexcharts.js is a modern javaScript charting library to build interactive charts and visualizations with
                                simple API. Please read the <a href="https://apexcharts.com/" target="_blank">official documentation</a> for
                    ...
                    <div class="col-xl-3">
                        ...
                        <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                            <nav class="nav">
                                ...
                                <nav-scroll-to class="nav-link" target="#apexChartLineChart" data-toggle="scroll-to">
                                    - line chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartColumnChart" data-toggle="scroll-to">
                                    - column chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartAreaChart" data-toggle="scroll-to">
                                    - area chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartBarChart" data-toggle="scroll-to">
                                    - bar chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartMixedChart" data-toggle="scroll-to">
                                    - mixed chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartCandlestickChart" data-toggle="scroll-to">
                                    - candlestick chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartBubbleChart" data-toggle="scroll-to">
                                    - bubble chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartScatterChart" data-toggle="scroll-to">
                                    - scatter chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartHeatmapChart" data-toggle="scroll-to">
                                    - heatmap chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartPieChart" data-toggle="scroll-to">
                                    - pie chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartRadialBarChart" data-toggle="scroll-to">
                                    - radial bar chart</nav-scroll-to
                                >
                                <nav-scroll-to class="nav-link" target="#apexChartRadarChart" data-toggle="scroll-to">
                                    - radar chart</nav-scroll-to
                                >
                            </nav>
                        </nav>
