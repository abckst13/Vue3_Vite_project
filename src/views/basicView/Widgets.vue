                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div id="cardWidget" class="mb-5">
                            <h4>Card widget</h4>
                            <p>
                                Card widget is created by using existing Bootstrap <code>.card</code> component with <code>.card-img</code>,
                                    ...
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <card class="p-5px">
                                                ...
                                                <card-img-overlay
                                                    class="d-flex flex-column bg-gray-700 bg-opacity-75 m-5px z-2"
                                                    data-bs-theme="dark"
                                                >
                                                    <div class="flex-fill">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="dropdown dropdown-icon ms-auto">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end" data-bs-theme="light">
                                                                    <a href="//www.youtube.com/watch?v=_AS5nu4u1ss" class="dropdown-item"
                                                                        >View</a
                                                                    >
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        >
                                                            <div
                                                                class="bg-gradient-blue-cyan w-50px h-50px rounded-3 d-flex align-items-center justify-content-center"
                                                            >
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="list-group mb-3">
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="dropdown">
                                                        <a href="#" data-bs-toggle="dropdown" class="text-inverse text-opacity-50"
                                                            ><i class="fa fa-ellipsis-h"></i
                                                        ></a>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    <div
                                                        class="w-40px h-40px d-flex align-items-center justify-content-center bg-gradient-orange text-white rounded ms-n1"
                                                    >
                                            ...
                                            <div class="list-group mb-3">
                                                ...
                                                >
                                                    ...
                                                    <div class="flex-fill ps-3 d-flex align-items-center">
                                                        <div class="fw-bold flex-fill">Isaiah Hughes</div>
                                                ...
                                                >
                                                    ...
                                                    <div class="flex-fill ps-3 d-flex align-items-center">
                                                        <div class="fw-bold flex-fill">Ryan Turner</div>
                        ...
                        <div id="chartWidget" class="mb-5">
                            <h4>Chart widget</h4>
                            <p>
                                Chart widget created by using Bootstrap <code>.card</code> and <code>.list-group</code> component combined
                                with Chart.js plugins.
                            </p>
                            <card>
                                <card-body>
                                    <div class="row">
                                            ...
                                            <card>
                                                ...
                                                <div class="list-group list-group-flush">
                                                    <div class="list-group-item border-top-0 rounded-top-0 d-flex align-items-center p-3">
                                                        <div
                                                            class="w-40px h-40px bg-inverse bg-opacity-15 d-flex align-items-center justify-content-center"
                                                        >
                            ...
                            <card>
                                <card-body>
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <card>
                                                <card-header class="bg-none fw-bold d-flex align-items-center"
                                                    >Discussion group <card-expand-toggler></card-expand-toggler
                                                ></card-header>
                                                            ...
                                                            <div class="widget-chat-item">
                                                                ...
                                                                <div class="widget-chat-content">
                                                                    ...
                                                                    <div class="widget-chat-message">
                                                                        Not much, It's got a new look, contact pics show up in group
                                                                        messaging, some other small stuff.
                                                                    </div>
                                                                    <div class="widget-chat-message last">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <div class="list-group">
                                                ...
                                                >
                                                    <div
                                                        class="w-60px h-60px d-flex align-items-center justify-content-center ms-n1 bg-white p-1"
                                                    >
                                                    ...
                                                    <div>
                                                        <span
                                                            class="badge bg-transparent border border-theme text-theme fs-12px fw-500 rounded-sm"
                                                        >
                                                            $999.00
                                                        </span>
                                                    </div>
                        ...
                        <div id="imageListWidget" class="mb-5">
                            ...
                            <p>
                                Image list widget created by using Bootstrap <code>.card</code> and <code>.list-group</code> component with
                                <code>.d-flex</code> utilities.
                            </p>
                            <card>
                                <card-body>
