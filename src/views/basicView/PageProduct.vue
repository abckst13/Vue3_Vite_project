<template>
    ...
    <div class="mb-sm-4 mb-3 d-sm-flex">
        ...
        <div class="ms-sm-4 mt-sm-0 mt-2">
            <a href="#" class="text-inverse text-opacity-75 text-decoration-none"
                ><i class="fa fa-upload fa-fw me-1 text-theme"></i> Import</a
            >
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <RouterLink to="/page/product-details" class="text-inverse text-opacity-75 text-decoration-none"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <RouterLink to="/page/product-details" class="text-inverse text-opacity-75 text-decoration-none"
                                                >Eco-friendly fashion, organic cotton, slow fashion polo shirts</RouterLink
                                            >
                                        </div>
                                    </div>
                                </td>
