                    ...
                    <div class="pos-container">
                        ...
                        <div class="pos-content h-100">
                            <perfect-scrollbar class="pos-content-container p-3 h-100">
                                <div class="row gx-3">
                                    <template v-if="tables">
                                        <div class="col-xl-3 col-lg-4 col-md-6 pb-3" v-for="table in tables">
                                            ...
                                            >
                                                <a
                                                    href="#"
                                                    class="pos-checkout-table-container"
                                                    v-on:click="event => toggleTable(event, table)"
                                                >
                                                    <div class="pos-checkout-table-header">
                                                        ...
                                                        <div class="text-inverse text-opacity-50">
                                                            ...
                                                            <span v-if="table.status == 'Reserved'"
                                                                >Reserved for {{ table.reserveName }}</span
                                                            >
                                                            <span v-if="!table.orders && table.status != 'Reserved'"
                                                                >max {{ table.totalPax }} pax</span
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="pos-checkout-table-info small">
                                                        <div class="row">
                                                            <div class="col-6 d-flex justify-content-center">
                                                                <div class="w-20px">
                                                                    <i class="bi bi-people text-inverse text-opacity-50"></i>
                                                                </div>
                                                                <div class="w-60px">{{ table.pax }} / {{ table.totalPax }}</div>
                                                            </div>
                                                            <div class="col-6 d-flex justify-content-center">
                                                                <div class="w-20px">
                                                                    <i class="bi bi-clock text-inverse text-opacity-50"></i>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6 d-flex justify-content-center">
                                                                <div class="w-20px">
                                                                    <i class="bi bi-receipt text-inverse text-opacity-50"></i>
                                                                </div>
                                                                <div class="w-60px">
                                                            ...
                                                            <div class="col-6 d-flex justify-content-center">
                                                                <div class="w-20px">
                                                                    <i class="bi bi-currency-dollar text-inverse text-opacity-50"></i>
                                                                </div>
                                                                <div
                                                                    class="w-60px"
                                                                    v-bind:class="{ 'text-success': table.status == 'Paid' }"
                                                                >
                                    ...
                                    <template v-else>
                                        <div class="col-12 pb-3">No records found</div>
                                    </template>
                                </div>
                            </perfect-scrollbar>
                        </div>
                        ...
                        <div class="pos-sidebar" id="pos-sidebar">
                            ...
                            <div class="pos-sidebar-header">
                                ...
                                <div class="order">
                                    Order:
                                    <b class="text-theme">#{{ selectedTable && selectedTable.orderNo ? selectedTable.orderNo : '-' }}</b>
                                </div>
                            </div>
                                            ...
                                            <div class="flex-1">
                                                <div class="row">
                                                    <div class="col-7">
                                                        ...
                                                        <div class="small">
                                                            <div v-for="option in order.options">- {{ option }}</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">x{{ order.quantity }}</div>
                                                    <div class="col-3 text-inverse fw-bold text-end">
