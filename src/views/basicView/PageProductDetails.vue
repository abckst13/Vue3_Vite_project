...
<template>
    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400"> Product Information </card-header>
                <card-body>
                    <div class="mb-3">
                    ...
                    <div class="">
                        ...
                        <div class="form-control p-0">
                            <div class="border-0"><quill-editor theme="snow" class="h-250px" /></div>
                        </div>
                    </div>
                </card-body>
            </card>
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400"> Media </card-header>
            ...
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-15 fw-400"> Variants </card-header>
                <card-body>
                    ...
                    <div class="row mb-3 gx-3">
                        <div class="col-4">
                            <input type="text" class="form-control" name="variant[0][name]" placeholder="e.g Size" value="Size" />
                        </div>
                        <div class="col-7">
                    ...
                    <div class="row mb-3 gx-3">
                        <div class="col-4">
                            <input type="text" class="form-control" name="variant[1][name]" placeholder="e.g Color" value="Color" />
                        </div>
                        <div class="col-7">
                    ...
                    <div class="row mb-3 gx-3">
                        <div class="col-4">
                            <input type="text" class="form-control" name="variant[1][name]" placeholder="e.g Color" value="Material" />
                        </div>
                        <div class="col-7">
            ...
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-15 fw-400"> Warranty </card-header>
                <card-body>
                    <div class="row">
                        <div class="col-lg-6">
            ...
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-15 fw-400"> Package Content </card-header>
                <card-body>
                    <div class="mb-3">
                    ...
                    <div class="p-3 bg-inverse bg-opacity-10">
                        <div class="form-group mb-0">
                            ...
                            <div class="shipping-container">
                                ...
                                <hr class="mt-2 mb-2" />
                                <div class="row align-items-center">
                                    <div class="col-6 pt-1 pb-1">AliExpress</div>
                                    <div class="col-6 d-flex align-items-center">
                                        <div class="form-check form-switch ms-auto">
                                            <input
                                                type="checkbox"
                                ...
                                <hr class="mt-2 mb-2" />
                                <div class="row align-items-center">
                                    <div class="col-6 pt-1 pb-1">SaleHoo</div>
                                    <div class="col-6 d-flex align-items-center">
                                        <div class="form-check form-switch ms-auto">
                                            <input
                                                type="checkbox"
                                ...
                                <hr class="mt-2 mb-2" />
                                <div class="row align-items-center">
                                    <div class="col-6 pt-1 pb-1">Megagoods</div>
                                    <div class="col-6 d-flex align-items-center">
                                        <div class="form-check form-switch ms-auto">
                                            <input
                                                type="checkbox"
                                ...
                                <hr class="mt-2 mb-2" />
                                <div class="row align-items-center">
                                    <div class="col-6 pt-1 pb-1">Wholesale2B</div>
                                    <div class="col-6 d-flex align-items-center">
                                        <div class="form-check form-switch ms-auto">
                                            <input
                                                type="checkbox"
                                ...
                                <hr class="mt-2 mb-2" />
                                <div class="row align-items-center">
                                    <div class="col-6 pt-1 pb-1">Sunrise Wholesale</div>
                                    <div class="col-6 d-flex align-items-center">
                                        <div class="form-check form-switch ms-auto">
                                            <input
                                                type="checkbox"
                ...
                <card-body>
                    <div class="d-flex">
                        ...
                        <div class="w-50px text-center">
                            <a href="#" class="text-decoration-none"><i class="bi bi-calendar fa-lg"></i></a>
                        </div>
                    </div>
                    <hr />
                    <div class="d-flex">
                    ...
                    <div class="d-flex">
                            ...
                            <div>
                                ...
                                <div class="d-flex mt-1 text-inverse text-opacity-50 small">
                                    ...
                                    <div class="flex-1 ps-2">
                                        <div class="mb-2">
                                            Amazon is disconnected. Connect your Amazon Seller Central account to continue using this sales
                                            channel.
                                        </div>
                                        <a href="#">Learn more</a>
                                    </div>
                        ...
                        <div class="w-50px text-center">
                            <a href="#" class="text-decoration-none text-inverse text-opacity-50"
                                ><i class="bi bi-x-circle-fill fa-lg fa-fw"></i
                            ></a>
                        </div>
                    </div>
                </card-body>
            ...
            <card class="mb-4">
                ...
                <card-body>
                    <div class="d-flex align-items-center position-relative fw-bold mb-2">
                        <span class="position-absolute top-0 bottom-0 start-0 d-flex align-items-center px-10px"
