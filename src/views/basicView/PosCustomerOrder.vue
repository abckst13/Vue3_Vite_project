...
export default {
    ...
    methods: {
        ...
        deductQty: function (event, id) {
            ...
            for (let i = 0; i < this.order.length; i++) {
                if (this.order[i].id == id) {
                    let newQty = parseInt(this.order[i].quantity) - 1;
        ...
        addQty: function (event, id) {
            ...
            for (let i = 0; i < this.order.length; i++) {
                if (this.order[i].id == id) {
                    const newQty = parseInt(this.order[i].quantity) + 1;
        ...
        deductModalQty: function (event) {
            ...
            let newQty = parseInt(this.modalQuantity) - 1;
        ...
        addToCart: function (event) {
            ...
            if (this.modalSelectedAddon) {
                for (let i = 0; i < this.modalSelectedAddon.length; i++) {
                    var option = {
                        key: 'addon',
                    ...
                    <perfect-scrollbar class="h-100">
                        <ul class="nav nav-tabs">
                            <li class="nav-item" v-for="category in menu.category">
                                ...
                                >
                                    <card>
                                        <card-body> <i v-bind:class="category.icon"></i> {{ category.text }} </card-body>
                                    </card>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="h-100 d-flex flex-column p-0">
                    ...
                    <div class="pos-sidebar-nav">
                        <ul class="nav nav-tabs nav-fill">
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-bs-toggle="tab" data-bs-target="#newOrderTab"
                                    >New Order ({{ getOrderTotal() }})</a
                                >
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-bs-toggle="tab" data-bs-target="#orderHistoryTab"
                                ...
                                <div class="pos-order-product">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            />
                                            <a href="#" class="btn btn-outline-theme btn-sm" v-on:click="event => addQty(event, order.id)"
                            ...
                            <div class="modal-pos-product">
                                ...
                                <div class="modal-pos-product-info d-flex flex-column">
                                    ...
                                    <div class="d-flex mb-3">
                                        <a href="#" class="btn btn-outline-theme" v-on:click="event => deductModalQty(event)"
                                            ><i class="fa fa-minus"></i
                                        ></a>
                                        <input
                                            type="text"
                                        ...
                                        />
                                        <a href="#" class="btn btn-outline-theme" v-on:click="event => addModalQty(event)"
                                            ><i class="fa fa-plus"></i
                                        ></a>
                                    </div>
