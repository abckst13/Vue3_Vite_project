    ...
    <div class="mb-md-4 mb-3 d-md-flex">
        <div class="mt-md-0 mt-2">
            <a href="#" class="text-inverse text-opacity-75 text-decoration-none"
                ><i class="fa fa-download fa-fw me-1 text-theme"></i> Export</a
            >
        </div>
        ...
        <div class="tab-content p-4">
            <div class="tab-pane fade show active" id="allTab">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="py-1 align-middle">
                                    <span
                                        ...
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Paid</span
                                    >
                                </td>
                                <td class="align-middle">
                                    <span
                                        class="badge border border-success text-success px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Fulfilled</span
                                    >
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="py-1 align-middle">
                                    <span
                                        ...
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Pending</span
                                    >
                                </td>
                                <td class="align-middle">
                                    <span
                                        class="badge border border-warning text-warning px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Unfulfilled</span
                                    >
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span
                                        class="badge border border-yellow text-warning px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Unfulfilled</span
                                    >
                                </td>
                                <td class="align-middle">2 items</td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span
                                        class="badge border border-primary text-primary px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Ready for pickup</span
                                    >
                                </td>
                                <td class="align-middle">2 items</td>
                                <td class="align-middle">Local pickup</td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span
                                        class="badge border border-primary text-primary px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Ready for delivery</span
                                    >
                                </td>
                                <td class="align-middle">1 item</td>
                                <td class="align-middle">Local pickup</td>
                            ...
                            <tr>
                                ...
                                <td class="py-1 align-middle">
                                    <span
                                        class="badge border border-gray-300 text-gray-300 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Partially refunded</span
                                    >
                                </td>
                                <td class="align-middle">
                                    <span
                                        class="badge border border-danger text-danger px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"
                                        ><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Partially fulfilled</span
                                    >
                                </td>
                                <td class="align-middle">2 items</td>
                                <td class="align-middle">Express</td>
                ...
                <div class="d-md-flex align-items-center">
                    <div class="me-md-auto text-md-left text-center mb-2 mb-md-0">Showing 1 to 10 of 57 entries</div>
