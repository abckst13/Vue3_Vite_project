...
<template>
    ...
    <h1 class="page-header">Collapsed Sidebar <small>page header description goes here...</small></h1>

    <hr class="mb-4" />

    <p>Add the following code within the <code>&lt;script&gt;</code> tag for collapsed sidebar page setting.</p>
