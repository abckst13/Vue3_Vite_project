        ...
        <div class="mailbox">
            ...
            <div class="mailbox-toolbar">
                ...
                <div class="mailbox-toolbar-item">
                    <RouterLink to="/email/compose" class="mailbox-toolbar-link text-inverse bg-inverse bg-opacity-15"
                    ...
                    <perfect-scrollbar class="h-100">
                        <div class="mailbox-list">
                            <div
                                ...
                                v-if="mailData"
                                v-for="mail in mailData"
                                v-bind:class="{ 'has-attachment': mail.hasAttachment, unread: mail.unread, active: mail.active }"
                            >
                            ...
                            <div class="mailbox-list-item" v-else>No records found</div>
                        </div>
                    </perfect-scrollbar>
                </div>
                <!-- END mailbox-sidebar -->
                    ...
                    <perfect-scrollbar class="h-100">
                        ...
                        <div class="mailbox-detail">
                                        ...
                                        <div class="d-lg-flex align-items-center">
                                            <div class="flex-1">
                                                ...
                                                <div class="fs-13px">
                                                    ...
                                                    <a href="#" class="text-decoration-none">support@seantheme.com</a>,
                                                    <a href="#" class="text-decoration-none">seantheme@admin.com</a>
                                                </div>
                                            </div>
                            ...
                            <div class="mailbox-detail-content">
                                ...
                                <div class="mb-3">
                                    <a href="#" class="btn btn-rounded px-3 btn-sm bg-theme bg-opacity-20 text-theme fw-600 rounded"
                                        >Download</a
                                    >
                                </div>
