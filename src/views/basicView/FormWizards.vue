            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <h1 class="page-header">Form Wizards <small>page header description goes here...</small></h1>
                        ...
                        <div id="wizardLayout1" class="mb-5">
                            ...
                            <p>
                                Wizard layout include the number of step and text. Please do note that all the wizard is for uxui ONLY but
                                do not include any javascript or backend logic.
                            </p>
                            <card>
                                <card-body>
                                    ...
                                    <card>
                                        <card-body> wizard content here </card-body>
                                    </card>
                                </card-body>
                    ...
                    <div class="col-xl-3">
                        ...
                        <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                            <nav class="nav">
                                <nav-scroll-to target="#wizardLayout1" class="nav-link" data-toggle="scroll-to"
                                    >Wizard layout 1</nav-scroll-to
                                >
                                <nav-scroll-to target="#wizardLayout2" class="nav-link" data-toggle="scroll-to"
                                    >Wizard layout 2</nav-scroll-to
                                >
                                <nav-scroll-to target="#wizardLayout3" class="nav-link" data-toggle="scroll-to"
                                    >Wizard layout 3</nav-scroll-to
                                >
                            </nav>
                        </nav>
