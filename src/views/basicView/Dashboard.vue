    ...
    methods: {
            ...
            return [
                {
                    ...
                    total: '4.2m',
                    info: [
                        { icon: 'fa fa-chevron-up fa-fw me-1', text: '33.3% more than last week' },
                        { icon: 'far fa-user fa-fw me-1', text: '45.5% new visitors' },
                        { icon: 'far fa-times-circle fa-fw me-1', text: '3.25% bounce rate' }
                    ],
                    chart: {
                        height: 30,
                        options: {
                ...
                },
                {
                    ...
                    total: '$35.2K',
                    info: [
                        { icon: 'fa fa-chevron-up fa-fw me-1', text: '20.4% more than last week' },
                        { icon: 'fa fa-shopping-bag fa-fw me-1', text: '33.5% new orders' },
                        { icon: 'fa fa-dollar-sign fa-fw me-1', text: '6.21% conversion rate' }
                    ],
                    chart: {
                        height: 30,
                        options: {
                ...
                },
                {
                    ...
                    total: '4,490',
                    info: [
                        { icon: 'fa fa-chevron-up fa-fw me-1', text: '59.5% more than last week' },
                        { icon: 'fab fa-facebook-f fa-fw me-1', text: '45.5% from facebook' },
                ...
                },
                {
                    ...
                    total: '4.5TB',
                    info: [
                        { icon: 'fa fa-chevron-up fa-fw me-1', text: '5.3% more than last week' },
                ...
                stats: [
                    {
                        ...
                        info: [
                            ...
                            { title: 'DISK D', value: '0.50GB', class: 'text-theme text-opacity-50' }
                        ],
                        chart: {
                            height: 50,
                            options: {
                    ...
                    },
                    {
                        ...
                        info: [
                            ...
                            { title: 'FTP', value: '1.25GB', class: 'text-theme text-opacity-50' }
                        ],
                        chart: {
                            height: 50,
                            options: {
        ...
        renderMap() {
            ...
            const map = new jsVectorMap({
                ...
                regionStyle: {
                    initial: { fill: appVariable.color.inverse, fillOpacity: 0.35, stroke: 'none', strokeWidth: 0.4, strokeOpacity: 1 },
                        ...
                        <table class="w-100 mb-0 small align-middle text-nowrap">
                            <tbody>
                                <tr v-if="products" v-for="(product, index) in products">
                                        ...
                                        <div class="d-flex">
                                            <div class="position-relative mb-2">
                                                <div
                                                    ...
                                                    v-bind:style="{ backgroundImage: 'url(' + product.img + ')' }"
                                                ></div>
                                    ...
                                    <td>
                                        <a href="#" class="text-decoration-none text-inverse"><i class="bi bi-search"></i></a>
                                    </td>
                                </tr>
                                <tr v-else>
                                    <td colspan="3">No records found</td>
