    ...
    <div class="mb-3 d-md-flex fw-bold">
        <div class="mt-md-0 mt-2">
            <a href="#" class="text-decoration-none text-inverse"
                ><i class="bi bi-printer fa-fw me-1 text-inverse text-opacity-50"></i> Print</a
            >
        </div>
        <div class="ms-md-4 mt-md-0 mt-2">
            <a href="#" class="text-decoration-none text-inverse"
                ><i class="bi bi-boxes fa-fw me-1 text-inverse text-opacity-50"></i> Restock items</a
            >
        </div>
        <div class="ms-md-4 mt-md-0 mt-2">
            <a href="#" class="text-decoration-none text-inverse"><i class="bi bi-pen fa-fw me-1 text-inverse text-opacity-50"></i> Edit</a>
        </div>
        <div class="ms-md-4 mt-md-0 mt-2 dropdown-toggle">
            <a href="#" data-bs-toggle="dropdown" class="text-decoration-none text-inverse"
                ><i class="bi bi-gear fa-fw me-1 text-inverse text-opacity-50"></i> More Actions</a
            >
    ...
    <div class="row gx-4">
        <div class="col-lg-8">
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400">
                    Products (3)
                    <a href="#" class="ms-auto text-decoration-none text-inverse text-opacity-50"
                        ><i class="bi bi-truck fa-lg me-1"></i> Add Tracking Link</a
                    >
                </card-header>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 d-flex align-items-center">
                            ...
                            <div class="ps-3 flex-1">
                                ...
                                <div class="text-inverse text-opacity-50 small">SKU: IP13PROMAX-512</div>
                            </div>
                        </div>
                        <div class="col-lg-2 m-0 ps-lg-3">$999 x 1</div>
                        <div class="col-lg-2 m-0 text-end">$999</div>
                    </div>
                    <hr class="my-4" />
                    <div class="row">
                        <div class="col-lg-8 d-flex align-items-center">
                            ...
                            <div class="ps-3 flex-1">
                                ...
                                <div class="text-inverse text-opacity-50 small">SKU: MACBOOKPRO-1TB</div>
                            </div>
                        </div>
                        <div class="col-lg-2 m-0 ps-lg-3">$1,999 x 1</div>
                        <div class="col-lg-2 m-0 text-end">$1,999</div>
                    </div>
                    <hr class="my-4" />
                    <div class="row">
                        <div class="col-lg-8 d-flex align-items-center">
                            ...
                            <div class="ps-3 flex-1">
                                ...
                                <div class="text-inverse text-opacity-50 small">SKU: APPLEWATCHBLACK</div>
                            </div>
                        </div>
                        <div class="col-lg-2 m-0 ps-lg-3">$599 x 1</div>
                        <div class="col-lg-2 text-inverse m-0 text-end">$599</div>
                    </div>
                </card-body>
                    ...
                    <table class="table table-borderless table-sm m-0">
                        <tbody>
                            ...
                            <tr>
                                <td>Shipping Fee</td>
                                <td>
                                    promo code: <u class="text-success fw-bold small">FREESHIPPING</u>
                                    <small>(<span class="text-decoration-line-through">$120.00</span>)</small>
                                </td>
                            ...
                            <tr>
                                <td class="pt-2 pb-2 text-nowrap">Paid by customer</td>
                                <td class="pt-2 pb-2">via <a href="#" class="text-decoration-none">Paypal</a> (#IRU9589320)</td>
        ...
        <div class="col-lg-4">
            <card class="mb-4">
                ...
                <card-body> No notes from customer </card-body>
            </card>
            <card class="mb-4">
                <card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400">
                    Customer
