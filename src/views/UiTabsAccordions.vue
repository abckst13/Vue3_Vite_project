            ...
            <div class="col-xl-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <h1 class="page-header">Tabs & Accordions <small>page header description goes here...</small></h1>
                        ...
                        <div id="tabs" class="mb-5">
                            ...
                            <p>
                                ...
                                create tabbable regions with bootstrap tab JavaScript plugin. Please read the
                                <a href="https://getbootstrap.com/docs/5.3/components/navs/#tabs" target="_blank"
                        ...
                        <div id="tabsV2" class="mb-5">
                            <h4>Tabs v2</h4>
                            <p>
                                This is an extended ui layout from default Bootstrap navigation tabs. Add <code>.nav-tabs-v2</code> to the
                                ...
                                <card-body class="pt-1">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-v2">
                                        <li class="nav-item me-3">
                                            <a href="#homev2" class="nav-link active" data-bs-toggle="tab">Home</a>
                                        </li>
                                        <li class="nav-item me-3">
                                            <a href="#profilev2" class="nav-link" data-bs-toggle="tab">Profile</a>
                                        </li>
                                            ...
                                            <card>
                                                <ul class="nav nav-tabs pt-3 px-3">
                                                    <li class="nav-item me-1">
                                                        <a href="#homeWithCard" class="nav-link active" data-bs-toggle="tab">Home</a>
                                                    </li>
                                                    <li class="nav-item me-1">
                                                        <a href="#profileWithCard" class="nav-link" data-bs-toggle="tab">Profile</a>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="col-xl-6">
                                            <card>
                                                <ul class="nav nav-tabs nav-tabs-v2 ps-4 pe-4">
                                                    <li class="nav-item me-3">
                                                        <a href="#homev2WithCard" class="nav-link active" data-bs-toggle="tab">Home</a>
                                                    </li>
                                                    <li class="nav-item me-3">
                                                        <a href="#profilev2WithCard" class="nav-link" data-bs-toggle="tab">Profile</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content p-4">
                                                    <!-- BEGIN tab-pane -->
                                ...
                                <card-body>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="pills-contact">
                                            ...
                                            veniam. Eiusmod minim exercitation fugiat irure ex labore incididunt do fugiat commodo aliquip
                                            sit id deserunt reprehenderit aliquip nostrud. Amet ex cupidatat excepteur aute veniam
                                            incididunt mollit cupidatat esse irure officia elit do ipsum ullamco Lorem. Ullamco ut ad minim
                                            do mollit labore ipsum laboris ipsum commodo sunt tempor enim incididunt. Commodo quis sunt
                                            dolore aliquip aute tempor irure magna enim minim reprehenderit. Ullamco consectetur culpa
                                            veniam sint cillum aliqua incididunt velit ullamco sunt ullamco quis quis commodo voluptate.
                                            Mollit nulla nostrud adipisicing aliqua cupidatat aliqua pariatur mollit voluptate voluptate
                                            consequat non.
                                        </div>
                                    </div>
                                </card-body>
                        ...
                        <div id="accordion" class="mb-5">
                            <h4>Accordion</h4>
                            <p>
                                Build vertically collapsing accordions in combination with Bootstrap Collapse JavaScript plugin. Please read
                                the
