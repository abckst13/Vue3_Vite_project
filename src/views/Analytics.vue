...
<template>
    ...
    <div class="d-flex align-items-center mb-3">
        <div class="btn btn-outline-theme d-flex align-items-center">
            ...
            <datepicker
                id="datepicker"
                class="bg-none text-reset shadow-none border-0 ps-2 w-100px p-0 outline-none"
            ...
            <card>
                <card-body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 text-end"><span class="text-danger">-</span> 50%</div>
                    </div>
        ...
        <div class="col-lg-6 col-xl-4 mb-4">
            ...
            <card>
                <card-body>
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <div><a href="#" class="text-decoration-none text-inverse text-opacity-50">/phone/apple-11-pro-max</a></div>
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <div>
                                <a href="#" class="text-decoration-none text-inverse text-opacity-50">/tablet/apple-ipad-pro-128gb</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div><a href="#" class="text-decoration-none text-inverse text-opacity-50">/desktop/apple-mac-pro</a></div>
                        </div>
