                    ...
                    <card-body class="p-2">
                        <div class="row gx-2">
                            <div class="col-6" v-for="mode in modeList">
                                ...
                                >
                                    <div class="img">
                                        <img v-bind:src="mode.img" class="object-fit-cover" height="76" width="76" v-bind:alt="mode.name" />
                                    </div>
                    ...
                    <card-body class="p-2">
                        <div class="app-theme-cover">
                            <div
                                ...
                                v-bind:class="{
                                    active:
                                        appOption.appCoverClass == cover.coverClass || (!appOption.appCoverClass && cover.name == 'Default')
                                }"
