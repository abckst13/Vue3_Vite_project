        ...
        <div class="brand">
            <RouterLink to="/" class="brand-logo">
                <span class="brand-img">
                    <span class="brand-img-text text-theme">DS</span>
                </span>
                <span class="brand-text">H C M S</span>
            </RouterLink>
        </div>
        <!-- END brand -->
            ...
            <div class="menu-item dropdown dropdown-mobile-full">
                ...
                <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                    ...
                    <RouterLink to="/email/inbox" class="dropdown-item d-flex align-items-center"
                        >INBOX <i class="bi bi-envelope ms-auto text-theme fs-16px my-n1"></i
                    ></RouterLink>
                    <RouterLink to="/calendar" class="dropdown-item d-flex align-items-center"
                        >CALENDAR <i class="bi bi-calendar ms-auto text-theme fs-16px my-n1"></i
                    ></RouterLink>
